...
class MainArgParser(argparse.ArgumentParser):
    def __init__(self):
        ...
        # train
        self.add_argument("--model", type=str, default="GraDKT")
        self.add_argument("--batch", type=int, default=128)
        self.add_argument("--epoch", type=int, default=100)
        ...
        self.add_argument("--gamma", type=float, default=0.1)
        
        self.add_argument("--recon_weight", type=float, default=0.1, help="Weight for reconstruction loss")
        ...
        self.add_argument("--graph_type", type=str, default="ori") 
...
def load_model(model_name, args):
    match model_name:
        case "GraDKT":
            ...
            from models.GraDKT import GraDKT
            model = GraDKT(num_c=args.concept,
                         num_q=args.question,
                         num_o=args.option,
                         dim_c=args.dim_c,
                         dim_q=args.dim_q,
